...
- Priority drag now begins and finishes on the stable Moves viewport, so the first drag receives immediate lift feedback and still persists after auto-scroll recycles its original row.
