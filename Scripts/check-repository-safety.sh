...
secret_pattern="(gh[pousr]_[A-Za-z0-9_]{20,}|github_pat_[A-Za-z0-9_]{20,}|AKIA[0-9A-Z]{16}|AIza[0-9A-Za-z_-]{30,}|sk-ant-[A-Za-z0-9_-]{20,}|sk-(proj-)?[A-Za-z0-9_-]{20,}|sk_(live|test)_[A-Za-z0-9]{16,}|(OPENAI_API_KEY|ANTHROPIC_API_KEY|COMPOSIO_API_KEY|STRIPE_SECRET_KEY)[[:space:]]*[:=][[:space:]]*[\"'][^\"']{12,}|-----BEGIN ([A-Z ]+ )?PRIVATE KEY-----|client_secret[[:space:]]*[:=][[:space:]]*[\"'][^\"']{12,})"
